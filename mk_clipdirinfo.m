...
wavfile = [wavdir filesep dirstrct.wavfls{1}];
[dmy,fs] = wavread(wavfile);
...
clipbuff = 0;
clipbuff = round(fs * clipbuff / 1000);
clipbuff = zeros(1,clipbuff);
...
for wavind = 1:wavnm
    ...
    s = filter(b,a,s);
    [sampstmp,onstmp] = ...
        wav2clips(s,winlen,winadv,config_strct.amp_thresh,gap_thresh,config_strct.normopt,config_strct.logopt,logthresh,minsamps,maxsamps);
