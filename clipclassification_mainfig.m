...
uimenu(h_classmenu,'Label','Estimate error','Tag','estimate_error','Callback','1');
uimenu(h_classmenu,'Label','Match directory','Tag','match_all_clips4','Callback','1');
uimenu(h_classmenu,'Label','Import class templates','Tag','import_templates','Callback','1');
uimenu(h_classmenu,'Label','Match clips from other','Tag','match_clips_from_other','Callback','1');
...
objtags = {'make_template','remove_template','merge_classes','change_label',...
    'add_to_class','remove_from_class','remove_from_sample','template_match_samples'};
